...
class SppolemtResult extends Component {
...
<Form onSubmit={this.handleSubmit}>
           ...
           <div className="col-sm-2">
           <Input type="select"  name="phase" id="phase" value={this.state.sppolemt.id.phase} onChange={this.handleChange} required>
                          <option defaultValue="1" value="1">Single Phase</option>
           ...
           <div className="col-sm-2">
           <Input type="select"  name="poleType" id="poleType" value={this.state.sppolemt.id.poleType}  onChange={this.handleChange} required>
         ...
         <div className="col-sm-2">
           ...
           <div className="col-sm-2">
           <Input type="select"  name="fromConductor" id="fromConductor" value={this.state.sppolemt.id.fromConductor} onChange={this.handleChange} required>
           ...
           <div className="col-sm-2">
           <Input type="select"  name="toConductor" id="toConductor"  value={this.state.sppolemt.id.toConductor} onChange={this.handleChange} required>
                          <option defaultValue="SERVICE" value="SERVICE">SERVICE</option>
                          <option value="FLY">FLY</option>
                          <option value="ABC">ABC</option>
                        </Input>
