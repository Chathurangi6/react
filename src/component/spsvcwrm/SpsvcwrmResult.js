...
class SpsvcwrmResult extends Component {
...
handleChange(event) {
  ...
  render() {
   ...
   <br/>
        ...
        <a className="path2" href="/spsvcwrm">   Add Material  </a> 
        </div>
...
<div class="card-body ">
        ...
        <div className="col-sm-1">
           ...
           <div className="col-sm-1">
           <Input type="select"  name="phase" id="phase" value={this.state.spsvcwrm.id.phase}  onChange={this.handleChange} required>
           ...
           <div className="col-sm-2">
           <Input type="select"  name="connectionType" id="connectionType" value={this.state.spsvcwrm.id.connectionType} onChange={this.handleChange} required>
           {/* <option >Please Select</option> */}
           ...
           <div className="col-sm-2">
           <Input type="select"  name="wiringType" id="wiringType" value={this.state.spsvcwrm.id.wiringType} onChange={this.handleChange} required>
           {/* <option >Please Select</option> */}
...
export default withRouter(SpsvcwrmResult);