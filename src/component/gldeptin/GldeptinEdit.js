...
const TITLE = 'Edit Cost Center Details';

class GldeptinEdit extends Component {
    ...
    async componentDidMount() {
        ...
        const gldeptin = await (await fetch(`/gldeptin/${this.props.match.params.deptId}`)).json();
        this.setState({ gldeptin: gldeptin });
        console.log(this.state.gldeptin.branchCode)
    ...
    async handleSubmit(event) {
        ...
        gldeptin.updUser = "Perera"

        await fetch('/gldeptin/upd/' + gldeptin.deptId, {
            method: 'PUT',
            headers: {
    ...
    render() {
        ...
        <a className="path" href="/gldeptin/view">   Cost Center Details</a> |
        <a className="path2" href="/gldeptin/view">   Edit CostCenter Details</a> 
        </div>
                    <Card className='card_gldeptin'>
                        <CardBody>
                            <CardTitle className="text-center" >Update Cost Center Details</CardTitle>
                            <CardText>
                                ...
                                <Row>
                                        <Col sm="6" >
                                            <AvGroup>
                                                <FormGroup row >
                                                    ...
                                                    <Col sm={8}><AvInput disabled type="text" name="deptId" id="deptId" value={gldeptin.deptId || ''} onChange={this.handleChange}
                                                        validate={{
                                                            required: { value: true }
                                            ...
                                            <AvGroup>
                                                <FormGroup row >
                                                    ...
                                                    <Col sm={8} className="height_gldeptin">
                                                        <AvField type="number" name="bulkSupplierTel" id="bulkSupplierTel" placeholder="0xxxxxxxxx" value={gldeptin.bulkSupplierTel || ''} onChange={this.handleChange}
                                                            validate={{
                                                                required: { value: true, errorMessage: 'This field is required' },
                                                                pattern: { value: '^([0]{1}[0-9]{9})$', errorMessage: 'Please enter a valid phone number' }
                                    ...
                                    <Row >
                                        ...
                                        <Col sm="6" >
                                            <Col sm={{ offset: 7 }} >
                                                <Button className="button_gldeptin" color="primary" type="submit" >Edit</Button>{' '}
...
export default withRouter(GldeptinEdit);